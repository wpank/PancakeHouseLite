...
def main():
  ...
  plistpath = scriptpath + "/resources/PancakeHouseLite-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PancakeHouseLite-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PancakeHouseLite-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PancakeHouseLite-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PancakeHouseLite-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PancakeHouseLite-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/PancakeHouseLite-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/PancakeHouseLite.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/PancakeHouseLite.iss",inplace=1):
